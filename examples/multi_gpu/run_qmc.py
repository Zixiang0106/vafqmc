...
# Full explicit AFQMC example config (stochastic VAFQMC trial).
# Important knobs are all exposed here, including values that match defaults.
...
cfg.propagation.n_eq_steps = 800
cfg.propagation.ortho_freq = 5
cfg.propagation.multi_gpu = True
# ---------------------------------------------------------------------------
# Logging
# ---------------------------------------------------------------------------
cfg.log.enabled = True
cfg.log.block_freq = 1
cfg.log.equil_freq = 100
...
cfg.stochastic_trial.local_energy_chunk_size = 2 
